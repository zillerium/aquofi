 ...
 * @param config.watch - if set to true, the events will be updated every pollingInterval milliseconds set at AquoConfig (default: false)
...
>({
  ...
  useInterval(
    ...
    watch ? (targetNetwork.id !== chains.hardhat.id ? AquoConfig.pollingInterval : 4_000) : null,
  );
